...
export default function Question({test}) {
  ...
  const {DataReducer:data,QuesidReducer:id,QuesarrayReducer:quesarr,ResultReducer:result,SectionReducer:section} = useSelector(state => state)
                    ...
                    {/* <RadioGroup aria-label="quiz" name="quiz" style={{color:'black',padding:8}}> */}
                        {ques.option_1.valid?
                            <View style={{display:'flex',flexDirection:'row',marginVertical:10}}>
                                <View style={{}}>
                                    <RadioButton value={ques.option_1._id} status={a[ques.option_1._id]} onPress={()=>{a[op1]='checked';fun(op1,'checked')}} />
                                </View>
                        ...
                        {ques.option_2.valid?
                            <View style={{display:'flex',flexDirection:'row',marginVertical:10}}>
                                <View style={{}}>
                                    <RadioButton value={ques.option_2._id} status={a[ques.option_2._id]} onPress={()=>{a[op2]='checked';fun(op2,'checked')}} />
                                </View>
                        ...
                        {ques.option_3.valid?
                            <View style={{display:'flex',flexDirection:'row',marginVertical:10}}>
                                <View style={{}}>
                                    <RadioButton value={ques.option_3._id} status={a[ques.option_3._id]} onPress={()=>{a[op3]='checked';fun(op3,'checked')}} />
                                </View>
                        ...
                        {ques.option_4.valid?
                            <View style={{display:'flex',flexDirection:'row',marginVertical:10}}>
                                <View style={{}}>
                                    <RadioButton value={ques.option_4._id} status={a[ques.option_4._id]} onPress={()=>{a[op4]='checked';fun(op4,'checked')}} />
                                </View>
                ...
                <View style={{margin:1,width}}>
                    ...
                    {/* <RadioGroup aria-label="quiz" name="quiz" style={{color:'black',padding:8}}> */}
                        {ques.option_1.valid?
                            <View style={{display:'flex',flexDirection:'row',marginVertical:10}}>
                                <View style={{}}>
                                    <Checkbox value={ques.option_1._id} status={a[ques.option_1._id]} onPress={()=>{fun(op1,'checked')}} />
                                </View>
                                <AutoHeightWebView originWhitelist={['*']} source={{ html: ques.option_1.content,baseUrl:server }} scalesPageToFit={false} />
                            </View>:<></>
                        }
                        {ques.option_2.valid?
                            <View style={{display:'flex',flexDirection:'row',marginVertical:10}}>
                                <View style={{}}>
                                    <Checkbox value={ques.option_2._id} status={a[ques.option_2._id]} onPress={()=>{fun(op2,'checked')}} />
                                </View>
                                <AutoHeightWebView originWhitelist={['*']} source={{ html: ques.option_2.content,baseUrl:server }} scalesPageToFit={false} />
                            </View>:<></>
                        }
                        {ques.option_3.valid?
                            <View style={{display:'flex',flexDirection:'row',marginVertical:10}}>
                                <View style={{}}>
                                    <Checkbox value={ques.option_3._id} status={a[ques.option_3._id]} onPress={()=>{fun(op3,'checked')}} />
                                </View>
                                <AutoHeightWebView originWhitelist={['*']} source={{ html: ques.option_3.content,baseUrl:server }} scalesPageToFit={false} />
                            </View>:<></>
                        }
                        {ques.option_4.valid?
                            <View style={{display:'flex',flexDirection:'row',marginVertical:10}}>
                                <View style={{}}>
                                    <Checkbox value={ques.option_4._id} status={a[ques.option_4._id]} onPress={()=>{fun(op4,'checked')}} />
                                </View>
                                <AutoHeightWebView originWhitelist={['*']} source={{ html: ques.option_4.content,baseUrl:server }} scalesPageToFit={false} />
                            </View>:<></>
                        }
        ...
        return (
            <View style={classes.sec7}>
                <View style={{margin:10}}>
                    <AutoHeightWebView originWhitelist={['*']} source={{ html: ques.question,baseUrl:server }} scalesPageToFit={false} />
                    <TextInput  mode="flat"  autoFocus  value={a} onChangeText={(text)=>{setAnswer([text])}} />
                </View>
            </View>
          )          
      }
        ...
        <>
            ...
            <View style={classes.sec5}>
                <View style={{display:'flex',flexDirection:'row'}}>
                    ...
                    <Picker
                        // mode="dropdown"
                        style={{minWidth:80,marginRight:50,alignSelf:'center',height:30,backgroundColor:'#3498db'}}
            ...
            {qtype(ques)}
            <View style={{display:'flex',flexDirection:'row',justifyContent:'space-around',marginTop:'auto'}}>
                <Button mode="contained" onPress={review} compact style={{backgroundColor:'#286090',flex:1}}>
                Mark For Review And Next
                </Button>
                <Button mode="contained" onPress={clearresponse} compact style={{backgroundColor:'#E74500',flex:1}}>
                Clear Response
                </Button>
                <Button mode="contained" onPress={savefun} compact style={{backgroundColor:'#449D44',flex:1}}>
                Save And Next
                </Button>
